...
func __serialize(instance: Variant, impl: JSONSerializationImpl) -> Variant:
	...
	return {
		"p": impl._vector2i.__serialize(instance.position, impl),
		"e": impl._vector2i.__serialize(instance.end, impl),
	}
...
func __deserialize(serialized: Variant, impl: JSONSerializationImpl) -> Variant:
	...
	rect2i.position = impl._vector2i.__deserialize(serialized["p"], impl)
	rect2i.end = impl._vector2i.__deserialize(serialized["e"], impl)
	return rect2i
