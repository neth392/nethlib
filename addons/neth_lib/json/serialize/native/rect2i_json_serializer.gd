...
owner: Object, property: Dictionary) -> Variant:
	...
	rect2i.position = impl._vector2i._deserialize(serialized["p"], impl, json_key, owner, property)
	rect2i.end = impl._vector2i._deserialize(serialized["e"], impl, json_key, owner, property)
	return rect2i
