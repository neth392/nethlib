...
func __serialize(instance: Variant, impl: JSONSerializationImpl) -> Variant:
	...
	return {
		"o": impl._vector2.__serialize(instance.origin, impl),
		"x": impl._vector2.__serialize(instance.x, impl),
		"y": impl._vector2.__serialize(instance.y, impl),
	}
...
func __deserialize(serialized: Variant, impl: JSONSerializationImpl) -> Variant:
	...
	transform2d.origin = impl._vector2.__deserialize(serialized["o"], impl)
	transform2d.x = impl._vector2.__deserialize(serialized["x"], impl)
	transform2d.y = impl._vector2.__deserialize(serialized["y"], impl)
	return transform2d
