...
owner: Object, property: Dictionary) -> Variant:
	...
	transform2d.origin = impl._vector2._deserialize(serialized["o"], impl, json_key, owner, property)
	transform2d.x = impl._vector2._deserialize(serialized["x"], impl, json_key, owner, property)
	transform2d.y = impl._vector2._deserialize(serialized["y"], impl, json_key, owner, property)
	return transform2d
